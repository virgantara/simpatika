...
{    /**
    ...
    public function rules()
    {
        return [
            ...
            [['permalink'], 'unique'],
            [['kode_unik','tanggal_lahir','bidang_ilmu_id','permalink','expertise','kepakaran_id','kode_feeder','id_reg_ptk','tugas_dosen_id','telegram_username','gelar_depan','gelar_belakang'], 'safe'],

...
<div class="row">
    <div class="col-lg-6">
         ...
         <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="form-group">
                    ...
                    <div class="form-line">
                    <?= $form->field($model, 'no_pendaftaran',['options' => ['tag' => false]])->textInput(['class'=>'form-control','maxlength' => true,'required'=>'required'])->label(false) ?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="form-group">
                    <label class="form-label">Status HKI</label>
                    <div class="form-line">
                    <?= $form->field($model, 'status_hki',['options' => ['tag' => false]])->dropDownList(['TERDAFTAR'=>'TERDAFTAR','GRANTED'=>'GRANTED'],['class'=>'form-control','required'=>'required'])->label(false) ?>
    ...
    {
        foreach($model->hkiAuthors as $dsn)
        {
    ?>

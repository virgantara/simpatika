...
class Google {
	...
	public function __construct(){
		...
		$this->client->setClientId(Yii::app()->params->clientId);
		$this->client->setClientSecret(Yii::app()->params->clientSecret);
		$this->client->setRedirectUri(Yii::app()->params->redirectURI);

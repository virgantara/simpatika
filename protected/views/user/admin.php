	...
	$(document).ready(function(){
		$('#search,#size').change(function(){
			$('#user-grid').yiiGridView.update('user-grid', {
			    url:'<?php echo Yii::app()->createUrl("User/admin"); ?>&filter='+$('#search').val()+'&size='+$('#size').val()
			});
		});
...
?>
<div class="pull-left"> <?php	echo CHtml::link('Tambah Baru',['User/create'],['class'=>'btn btn-success']);
?></div>

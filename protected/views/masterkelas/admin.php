	...
	$(document).ready(function(){
		$('#search,#size').change(function(){
			$('#masterkelas-grid').yiiGridView.update('masterkelas-grid', {
			    url:'<?php echo Yii::app()->createUrl("Masterkelas/admin"); ?>&filter='+$('#search').val()+'&size='+$('#size').val()
			});
		});
...
?>
<div class="pull-left"> <?php	echo CHtml::link('Tambah Baru',['Masterkelas/create'],['class'=>'btn btn-success']);
?></div>

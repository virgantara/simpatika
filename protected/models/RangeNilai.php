 ...
 *
 * The followings are the available columns in table 'simak_range_nilai':
 * @property integer $id
 * @property double $dari
 * @property double $sampai
 * @property string $nilai_huruf
 */
class RangeNilai extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('dari, sampai, nilai_huruf', 'required'),
			array('dari, sampai', 'numerical'),
			array('nilai_huruf', 'length', 'max'=>2),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, dari, sampai, nilai_huruf', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return RangeNilai the static model class
	 */

 ...
 *
 * The followings are the available columns in table 'm_hari':
 * @property integer $id
...
class Hari extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_hari', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nama_hari, urutan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nama_hari',$this->nama_hari,true);
